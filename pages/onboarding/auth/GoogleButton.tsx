...
const buttonClasses = `
  group w-full h-[56px] flex items-center justify-center gap-2.5 px-5 rounded-full
  border border-[#3A4D55] bg-[#202F35] text-white font-sans font-extrabold text-[15px]
  shadow-[0_3px_0_#0B1519] hover:bg-[#26383F] hover:border-[#4A5F68]
...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 48 48" className="w-[19px] h-[19px] shrink-0" aria-hidden="true">
