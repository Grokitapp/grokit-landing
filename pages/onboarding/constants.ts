...
// Steps absent from this map do not show the back button.
...
export const TIME_OPTIONS = [
  {
    id: '5',
    label: '5 min',
    description: 'Just a quick spark',
  },
  {
    id: '10',
    label: '10 min',
    description: 'Your coffee break',
  },
  {
    id: '15',
    label: '15 min',
    description: 'A lunch-break session',
  },
  {
    id: '20',
    label: '20+ min',
    description: "I'm serious about this",
  },
];
...
export const EXAMPLE_COURSES = [
  {
    ...
    blurb: 'Build better habits to optimize your study time.',
  },
  {
    title: 'Deep Dive Into LLMs',
    author: 'Andrej Karpathy',
    tag: 'AI',
    blurb: 'Explores the core technology behind modern language models.',
  },
];
