...
const InstagramIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} {...strokeIconProps}>
        ...
        <div className="flex items-center gap-5">
          {socials.map(({ icon: Icon, href, label }) => (
            <a
              ...
              aria-label={label}
              className="
                w-11 h-11 rounded-full bg-peach
                flex items-center justify-center
                text-link hover:bg-orange hover:text-white
