    ...
    className="relative py-12 md:py-20 bg-surface">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          <span className="text-sm font-mono text-orange uppercase tracking-wider font-bold">How it works</span>
        </motion.div>
        ...
        <div className="flex gap-8 mb-12">
          ...
          idx === activeStep ? 'text-ink' : 'text-muted'}`
            ...
            <motion.div
              ...
              className="absolute -bottom-2 left-0 right-0 h-0.5 bg-gradient-to-r from-orange to-amber" />
              ...
              className="flex flex-col gap-8">
                ...
                <div className="max-w-2xl bg-surface-alt border border-line rounded-3xl p-6">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange to-amber flex items-center justify-center">
                      <span className="text-xs">✨</span>
                    </div>
                    <div className="flex-1">
                      <p className="text-body font-sans font-medium text-lg">
                        {steps[0].example}
                        <span className={`inline-block w-0.5 h-5 bg-orange ml-1 align-middle transition-opacity ${cursorVisible ? 'opacity-100' : 'opacity-0'}`} />
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <motion.div
              ...
              className="flex flex-col gap-8">
                ...
                <motion.div
                  ...
                  idx === 2 ?
                  'bg-gradient-to-r from-orange to-amber text-white border-transparent' :
