    ...
    className="relative py-12 md:py-20 bg-surface overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-12">
        ...
        <motion.div
          ...
          <div className="relative bg-surface-alt border border-line rounded-3xl p-6 md:p-8 hover:border-orange/30 transition-colors duration-500">
            {/* Decorative element */}
        ...
        <motion.div
          ...
          <motion.button
            ...
            className="px-4 py-2 text-sm font-sans font-bold text-body border border-line rounded-full hover:border-orange hover:text-orange transition-colors duration-300"
            disabled={isTyping}>
