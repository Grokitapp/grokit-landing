...
export function TrustStrip() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(32,21,16,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(32,21,16,0.15) 1px, transparent 1px)`,
      ...
      <motion.div
        ...
        <div className="flex flex-col gap-4">
          ...
          <motion.p
            ...
            <span className="text-orange">understanding.</span>
          </motion.p>
        </div>
      </motion.div>
    </section>
