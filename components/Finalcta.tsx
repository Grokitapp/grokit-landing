    ...
    <section className="relative py-12 md:py-20 bg-surface">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, var(--color-orange), var(--color-orange-glow))' }}>
          ...
          <div className="relative flex flex-col items-center">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white text-orange font-display font-bold px-8 py-4 text-base sm:text-lg shadow-lg hover:brightness-95 transition">
