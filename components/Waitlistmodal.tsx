          ...
          className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 text-muted hover:text-ink transition-colors">
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}>
                  ...
                  errors.firstName ? 'border-red-500 focus:border-red-500' : 'border-line focus:border-cobalt'}`}
                  ...
                  className={`w-full px-4 py-2.5 sm:py-3 bg-surface-alt border rounded-xl text-ink font-sans placeholder:text-muted focus:outline-none transition-colors ${
                  errors.email ? 'border-red-500 focus:border-red-500' : 'border-line focus:border-cobalt'}`}
                  ...
                  className="w-full px-4 py-2.5 sm:py-3 bg-surface-alt border border-line rounded-xl text-ink font-sans placeholder:text-muted focus:outline-none focus:border-cobalt transition-colors"
